<template>
  <div class="h-100 w-100 mx-auto d-flex align-center justify-center">
    <div class="py-12">
      <VCard width="380" class="elevation-4">
        <VCardTitle>
        ...
        <VCardText>
          <h1 class="my-4 text-center text-primary font-bold text-2xl">
